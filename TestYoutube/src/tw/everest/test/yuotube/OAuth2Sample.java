...
public class OAuth2Sample {
	   ...
	   */
	  private static final String APPLICATION_NAME = "Youtube-Test01";
	  ...
	  private static Credential authorize() throws Exception {
	    ...
	    clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
	        new InputStreamReader(OAuth2Sample.class.getResourceAsStream("/resources/client_secret_Other.json")));
